...
export const OFFICIAL_LINKS = Object.freeze({
  ...
  cwmGithub: 'https://github.com/facebookresearch/cwm',
  cwmHuggingFace: 'https://huggingface.co/facebook/cwm',
  cwmLicense: 'https://ai.meta.com/resources/models-and-libraries/cwm-license/',
  cwmPaper: 'https://arxiv.org/abs/2510.02387',
});
...
export function isDirectorKorniaCompatible(version, requiresLegacyPyramidApi = true) {
  if (!version) return false;
  return !requiresLegacyPyramidApi || compareVersions(version, '0.8.3') < 0;
}
...
async function getPythonAudit(comfyRoot) {
  ...
  const selectedNames = new Set(['torch', 'torchvision', 'torchaudio', 'transformers', 'numpy', 'kornia', 'comfyui-frontend-package', 'comfyui-workflow-templates', 'comfyui-embedded-docs', 'comfy-kitchen']);
  return {
