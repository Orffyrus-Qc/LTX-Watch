...
Copy-InstallerFile (Join-Path $projectRoot 'create-core.mjs') (Join-Path $stageRoot 'create-core.mjs')
...
Copy-InstallerFile (Join-Path $projectRoot 'scripts\ltx-create-runner.py') (Join-Path $stageRoot 'scripts\ltx-create-runner.py')
Copy-InstallerFile (Join-Path $projectRoot 'scripts\blender-physics-backbone.py') (Join-Path $stageRoot 'scripts\blender-physics-backbone.py')
Copy-InstallerFile (Join-Path $projectRoot 'scripts\blender-autopilot.py') (Join-Path $stageRoot 'scripts\blender-autopilot.py')
Copy-InstallerFile (Join-Path $projectRoot 'scripts\ltx-autopilot-runner.py') (Join-Path $stageRoot 'scripts\ltx-autopilot-runner.py')
Copy-InstallerFile (Join-Path $projectRoot 'scripts\run-hidden-python.py') (Join-Path $stageRoot 'scripts\run-hidden-python.py')
